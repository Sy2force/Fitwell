...
class BlogTests(TestCase):
    def setUp(self):
        ...
        # Manually create profile for test user since signals might not be set up or working in test env
        from users.models import Profile
        Profile.objects.get_or_create(user=self.user)
        self.user.refresh_from_db()  # Ensure profile is attached to user instance
    ...
    def test_update_user_profile(self):
        ...
        data = {
            'profile': {
                'bio': 'Updated bio',
                'avatar': 'https://fitwell.net/avatar.jpg'
            }
        }
        ...
        self.assertEqual(self.user.profile.avatar, 'https://fitwell.net/avatar.jpg')
