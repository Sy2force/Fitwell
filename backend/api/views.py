...
from .models import Article, Comment, Category, User, WellnessPlan, UserStats, WorkoutSession, ExerciseSet, Exercise
from .serializers import (ArticleSerializer, CommentSerializer, CategorySerializer, UserSerializer, 
                         WellnessPlanSerializer, EmailTokenObtainPairSerializer, WorkoutSessionSerializer,
                         WorkoutSessionCreateSerializer, ExerciseSetSerializer, ExerciseSetCreateSerializer,
                         ExerciseSerializer)
